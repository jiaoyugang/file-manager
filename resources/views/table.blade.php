        ...
        <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('file-manager', ['path' => $url['path'], 'view' => 'table']) }}" class="btn btn-default active"><i class="fa fa-list"></i></a>
                        <a href="{{ route('file-manager', ['path' => $url['path'], 'view' => 'list']) }}" class="btn btn-default"><i class="fa fa-th"></i></a>
                    </div>
            ...
            <div class="box-footer">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            {!! $item['preview'] !!}
                            {{-- <span class="file-icon has-img"><img src="https://demo.laravel-admin.org/uploads/files/images.png" alt="Attachment"></span> --}}
