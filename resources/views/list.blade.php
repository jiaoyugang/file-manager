        ...
        <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('file-manager', ['path' => $url['path'], 'view' => 'table']) }}" class="btn btn-default {{ request('view') == 'table' ? 'active' : '' }}"><i class="fa fa-list"></i></a>
                        <a href="{{ route('file-manager', ['path' => $url['path'], 'view' => 'list']) }}" class="btn btn-default {{ request('view') == 'list' ? 'active' : '' }}"><i class="fa fa-th"></i></a>
                    </div>
            ...
            <div class="box-footer">
                <ol class="breadcrumb" style="margin-bottom: 10px;">
                    ...
                    <li><a href="{{ route('file-manager') }}"><i class="fa fa-th-large"></i> </a></li>
                              ...
                              {{ $item['size'] }}&nbsp;
                                ...
                                <div class="btn-group btn-group-xs pull-right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="#" class="file-rename" data-toggle="modal" data-target="#moveModal" data-name="{{ $item['name'] }}">修改</a></li>
                                        <li><a href="#" class="file-delete" data-path="{{ $item['name'] }}" 
                                        @if ($item['isDir'])
                                            data-type="1"
                                        @else
                                            data-type="0"
                                        ...
                                        @endunless
                                        {{-- <li class="divider"></li> --}}
                                        <li><a href="#" data-toggle="modal" data-target="#urlModal" data-url="{{ $item['url'] }}">链接</a></li>
                                    </ul>
                                </div>
                            </span>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="moveModalLabel">修改文件名</h4>
            </div>
            <form id="file-move">
...
<div class="modal fade" id="urlModal" tabindex="-1" role="dialog" aria-labelledby="urlModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="urlModalLabel">文件路径</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
